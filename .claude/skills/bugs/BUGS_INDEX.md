...
| [028](BUG-028-zeichen-kommt-einen-wurf-zu-spaet/SKILL.md) | `STATE` | Ein zwischen zwei Wuerfen gesehener Spielwechsel kam einen Wurf zu spaet: Der erste Wurf des neuen Spiels landete im alten, und sein Betrag fehlte den Rest des Spiels | 2026-09-17 | **hoch** | `test_game_reset.py` |
