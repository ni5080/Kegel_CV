...
| [030](BUG-030-wurf-faellt-in-die-erholungszeit/SKILL.md) | `DETECT` | Die Selbstheilung der festhaengenden Wache wartet 750 Frames -- ein ganzer Wurfzyklus passt hinein, und der Wurf ist weg. Zwei von drei Zeugen sagten die ganze Zeit, dass nichts verdeckt ist | 2026-09-17 | mittel | `test_wache_bremst_nicht_allein.py` |
| [031](BUG-031-die-grundlinie-gehoert-zu-einem-anderen-augenblick/SKILL.md) | `ANALYSE` | Die Grundlinie (wie viele Kegel lagen schon) wird beim Gruen-AN gemessen und beim Gruen-AUS verwendet -- ist die Gruenphase 15 Frames kurz oder 87 Sekunden lang, gehoert sie zu einem anderen Augenblick als der Wurf. Die laufende Lampenspur wusste es die ganze Zeit besser (gemessen 99,54 -> 99,77 % und 99,51 -> 100 %) | 2026-09-18 | mittel | `test_grundlinie_aus_spur.py` |
| [032](BUG-032-der-erste-wurf-steht-noch-auf-null/SKILL.md) | `COUNT` | Wurfnummer und Summe stehen beim ERSTEN Wurf eines Spiels beide auf null -- die Regel liest das als 'kein Wurf' und verwirft ihn. Die Lampen sahen sechs Kegel fallen und wurden nie gefragt | 2026-09-18 | niedrig | noch offen |
